...
/* Größere Komponenten, die nicht sofort (also z.B. erst nach
  ...
  */
/* die Komponanete soll nur geladen werden, wenn wir sie brauchen */
...
export default function MoviesFinder() {
	return (
    	...
    	die während der Ladezeit von ContactPage angezeigt wird. */}
			{/* Route (oder jede andere Komponente) in Suspense wrappen und eine Fallback-Funktion angeben, 
			wo etwas während des Ladens angezeigt wird.  */}
			<Suspense fallback={<ColorRing wrapperClass="spinner" />}>
				{' '}
