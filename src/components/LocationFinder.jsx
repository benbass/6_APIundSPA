...
export default function LocationFinder() {
	...
	// Mit dem debounce hook soll die Such-Function nicht bei jeder Tastatureingabe starten sondern verzögert
	const debounceSearch = useDebouncedValue(search, 600);

	useEffect(() => {
		// Die Suche soll erst bei der Eingabe von mind. 2 Zeichen anfangen
